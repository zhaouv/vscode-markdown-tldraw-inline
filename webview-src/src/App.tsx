...
const saveBundleSvg = ()=>{
    ...
    return editor_g.getSvgString([...editor_g.getCurrentPageShapeIds()], {
        ...
        return d.svg.replace('<defs/>','<!-- payload-version:0.1 --><!-- payload-start -->'+payload+'<!-- payload-end --><defs/>')
    })
}
const loadBundleSvg = (svgtext)=>{
    let payload=/<!-- payload-start -->([^<]+)<!-- payload-end -->/.exec(svgtext)[1]
...
globalThis.click1=()=>{
    saveBundleSvg().then(e=>console.log(e))
    // globalThis.alert(1)
}
...
const Zone1 = () => {
    return (
        <h3 onClick={click1} style={{ zIndex: 100000, pointerEvents: "all" }} title='Ctrl+s'>💾&nbsp;&nbsp;&nbsp;</h3>
    );
};
const Zone2 = () => {
    return (
